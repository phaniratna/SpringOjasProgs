...
/*
@NamedQueries(value= {
	@NamedQuery(name="Person.findPersonInfobyLastName",
...
@NamedNativeQueries(value = { 
		@NamedNativeQuery(name="Person.findPersonInfobyLastName",
		query="SELECT * FROM person_table WHERE last_name=?1",
		resultClass=Person.class) ,
		
		@NamedNativeQuery(name="Person.findPersonInfobyFirstNameorEmail",
		query="SELECT * FROM person_table WHERE last_name=?1 or email=?2 ",
		resultClass=Person.class) 
		})
